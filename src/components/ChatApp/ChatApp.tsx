    ...
    return (
        <Box style={{ display: 'flex', minHeight: '100%' }}>
            ...
            <Flex direction="column" style={{ flex: 1, backgroundColor: 'var(--color-background-default)', minHeight: '100%' }}>
                ...
                {/* Messages Area */}
                <Box
                    style={{ flex: 1, overflow: 'hidden', padding: 'var(--space-gap-lg)', display: 'flex', flexDirection: 'column', minHeight: 0 }}
                    ref={messagesRef}
                >
                    {messages.length === 0 ? (
                        ...
                        <Stack spacing="md" style={{ flex: 1, overflowY: 'auto', minHeight: 0 }}>
                            {messages.map((msg) => {
                                ...
                                return (
                                    <Flex key={msg.id} direction="column" align={isOwnMessage ? 'flex-end' : 'flex-start'} style={{ width: '100%' }}>
